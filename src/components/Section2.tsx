...
const EventItem = ({ title, content }: { title: string; content: string }) => {
  const [isOpen, setIsOpen] = useState(false);

  return (
    <div className="w-full md:w-[580px] text-white">
      <div
        className={
      ...
      >
        <div className="text-[20px] md:text-[24px] font-semibold">{title}</div>
